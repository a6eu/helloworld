...
function Brandname() {
    ...
    useEffect(() => {
        const fetchProducts = async () => {
            try {
                const response = await axios.get('https://helloworlddjangotestdeploy-production.up.railway.app/api/v1/brands/');
                ...
                <div className="flex">
                    <div className="flex-1">
                        ...
                        <p className="text-gray-700 mb-4 font-normal">
                            Корпорация Dell обеспечивает вас теми технологиями, которые позволяют воплощать мечты в
                            жизнь.
                            Клиенты доверяют нам технологические решения, которые помогают им работать более эффективно,
                            достигать новых успехов и расти, и мы стремимся предложить более цветные истории, цветы и
                            лого, которые воплощают в жизнь нашу страсть, ориентированную на клиента.
                        </p>
                    ...
                    <div className="flex-shrink-0 ml-4">
                        <img src=".\images/dellLogo.png"
                             alt="DELL logo with blue circle and the word DELL in capital letters inside"
