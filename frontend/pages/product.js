    ...
    return (
        <div className="bg-neutral-100 flex flex-col items-stretch">
            <div className="self-center flex w-full max-w-[1112px] flex-col mt-5 px-5 max-md:max-w-full">
                <div
                    className="flex items-start gap-3.5 self-start max-md:max-w-full max-md:flex-wrap max-md:justify-center">
                    <div
                    ...
                    />
                    <div
                        className="justify-center text-sky-700 text-xs font-medium tracking-wide whitespace-nowrap mt-1 self-start">
                        Сервер Dell PowerEdge R540 (210-ALZH-B)
                    </div>
                </div>
                <div
                    className="shadow-sm bg-white self-stretch mt-7 pl-10 pr-5 py-3.5 rounded-md max-md:max-w-full max-md:pl-5">
                    <div className="gap-5 flex max-md:flex-col max-md:items-stretch max-md:gap-0">
                        ...
                        <div className="flex flex-col items-stretch w-[69%] ml-5 max-md:w-full max-md:ml-0">
                            <div className="flex flex-col my-auto max-md:max-w-full max-md:mt-10">
                                <div
                                    className="self-stretch flex justify-between gap-1.5 items-start max-md:max-w-full max-md:flex-wrap max-md:justify-center">
                                    <div
                                        className="text-black text-3xl font-light grow whitespace-nowrap max-md:max-w-full">
                                        Сервер Dell PowerEdge R540 (210-ALZH-B)
                                    </div>
                                    <Image
                                        alt={"hi"}
                                ...
                                <div className="flex items-stretch gap-1.5 mt-4 self-start">
                                    ...
                                    />
                                    <div
                                        className="text-neutral-400 text-xs font-light self-center grow whitespace-nowrap my-auto">
                                        35 отзывов
                                    </div>
                                </div>
                                <div
                                    className="text-black text-3xl font-light self-stretch whitespace-nowrap mt-11 max-md:max-w-full max-md:mt-10">
                                ...
                                <div
                                    className="self-stretch flex w-full items-stretch justify-between gap-5 mt-6 max-md:max-w-full max-md:flex-wrap">
                                    <Image
                                        alt={"hi"}
                                        loading="lazy"
                                        srcSet="..."
                                    ...
                                    <div className="flex items-stretch gap-px mt-5 self-start max-md:justify-center">
                                        ...
                                        />
                                        <div
                                            className="justify-center text-white text-xl font-medium whitespace-nowrap border bg-sky-700 aspect-[0.9259259259259259] items-stretch px-2 py-2 rounded border-solid border-sky-700 self-start">
                                            2
                                        </div>
                                        <Image
                                            alt={"hi"}
                                        ...
                                        />
                                        <div
                                            className="justify-center text-sky-700 text-center text-xs font-medium whitespace-nowrap border grow items-stretch px-7 py-3 rounded border-solid border-sky-700 max-md:px-5">
                                            В КОРЗИНУ
                                        </div>
                                    </div>
                                </div>
                ...
                <div
                    className="border flex items-stretch justify-between gap-5 ml-40 mt-6 pl-1 pr-3 py-1 rounded-md border-solid border-sky-700 self-start max-md:justify-center max-md:ml-2.5">
                    <div
                        className="justify-center text-white text-center text-sm font-medium whitespace-nowrap shadow-sm bg-sky-700 grow items-stretch px-3.5 py-1.5 rounded">
                        ОПИСАНИЕ
                    </div>
                    ...
                    <div
                        className="justify-center text-sky-700 text-center text-sm font-medium self-center whitespace-nowrap my-auto">
                        ДОСТАВКА
                    </div>
                </div>
                <div className="self-stretch mt-2.5 max-md:max-w-full">
                    <div className="gap-5 flex max-md:flex-col max-md:items-stretch max-md:gap-0">
                        <div className="flex flex-col items-stretch w-[61%] max-md:w-full max-md:ml-0">
                            <div
                                className="shadow-sm bg-white flex grow flex-col items-stretch w-full pt-3.5 pb-10 px-5 rounded-md max-md:max-w-full max-md:mt-5">
                                <div
                                    className="flex items-stretch justify-between gap-0 max-md:max-w-full max-md:flex-wrap">
                                    <div
                                        className="text-zinc-800 text-sm items-stretch bg-white grow justify-center px-6 py-3.5 max-md:px-5">
                                        Microsoft_UX_Design
                                    </div>
                                    <div
                                        className="text-zinc-800 text-sm items-stretch bg-white grow justify-center px-6 py-3.5 max-md:px-5">
                                ...
                                <div
                                    className="flex items-stretch justify-between gap-0 max-md:max-w-full max-md:flex-wrap">
                                    <div
                                        className="text-zinc-800 text-sm items-stretch bg-neutral-100 grow justify-center px-6 py-3.5 max-md:px-5">
                                        Microsoft_UX_Design
                                    </div>
                                    <div
                                        className="text-zinc-800 text-sm items-stretch bg-neutral-100 grow justify-center px-6 py-3.5 max-md:px-5">
                        ...
                        <div className="flex flex-col items-stretch w-[39%] ml-5 max-md:w-full max-md:ml-0">
                            <div
                                className="shadow-sm bg-white flex flex-col w-full pt-5 pb-11 px-5 rounded-md max-md:max-w-full max-md:mt-5">
                                <Image
                                    alt={"hi"}
                                    loading="lazy"
                                    srcSet="..."
                                ...
                                <div
                                    className="text-sky-700 text-center text-base font-light underline self-center whitespace-nowrap mt-8">
                                    Все товары категории
                                </div>
                                <div
                                    className="text-sky-700 text-center text-base font-light underline self-center whitespace-nowrap mt-2">
                ...
                <div
                    className="self-stretch flex items-start justify-between gap-5 mt-7 max-md:max-w-full max-md:flex-wrap max-md:justify-center">
                    <Image
                        alt={"hi"}
                        loading="lazy"
                    ...
                    />
                    <div
                        className="shadow-sm bg-white self-stretch flex grow basis-[0%] flex-col px-2 py-2.5 rounded-md">
                        <Image
                            alt={"hi"}
                            loading="lazy"
                            srcSet="..."
                ...
                <div
                    className="text-sky-700 text-center text-xl font-light leading-5 uppercase self-center whitespace-nowrap mt-9">
                    ПЕРСОНАЛЬНЫЕ РЕКОМЕНДАЦИИ
                </div>
                <div
                    className="self-stretch flex items-start justify-between gap-5 mt-6 max-md:max-w-full max-md:flex-wrap max-md:justify-center">
                    <Image
                        alt={"hi"}
                        loading="lazy"
                        src="https://cdn.builder.io/api/v1/image/assets/TEMP/76f6ffc7d605356ffca3cbed5034b20abd084ec59afbbca9dc60bdedc1c1c6b4?"
