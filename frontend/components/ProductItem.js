...
const ProductItem = ({product, signedIn}) => {
    ...
    return (
        <div className={styles.productCard}>
            ...
            >
                <Image
                    className='w-[180px] h-[150px] mt-[10px] bg-[#F6F6F6] border-r-[3px] transition-[300ms] flex justify-center items-center'
                    src={product.img_url} alt={product.name} width={180} height={180}/>
            </Link>
