            ...
            <Dialog as="div" className="select-none fixed top-0 left-0 w-full h-full bg-black bg-opacity-20 z-50" open={isOpen} onClose={onClose}>
                {isSignUp ? (
                    <Dialog.Panel className="fixed flex-wrap justify-center bg-white w-1/3 top-[20%] left-[33%] rounded-lg pt-5 ">
                        ...
                        <div className="flex flex-col py-5 w-full h-min bg-white rounded-lg">
                            <form className="w-full max-w-lg px-[90px] flex flex-wrap mb-6">
                                ...
                                <input
                                    className="flex w-full flex-wrap w-[50%] h-8 bg-[#1075B2] justify-center text-white rounded"
                    ...
                    <Dialog.Panel
                        ...
                        <div className="flex flex-wrap py-5 h-min bg-white px-[70px] rounded-lg">

                            <form className="w-full justify-center max-w-lg flex flex-wrap mb-6">
