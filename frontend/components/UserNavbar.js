    ...
    return (
        <div className={styles.userNavbar}>
            <div className="flex flex-col justify-between">
                <Link href={"/profile"} className={`flex-wrap flex hover:text-[#1075B2] cursor-pointer ${router.pathname === '/profile' ? 'text-[#1075B2]' : ''}`}>
                ...
                <Link
                    ...
                    <h3 className="mt-[5px] ml-[23px] font-sans hidden md:flex">Избранное</h3>
                </Link>
                <Link href={"/my_orders"}
                      className={`flex flex-wrap hover:text-[#1075B2] cursor-pointer ${router.pathname === '/my_orders' ? 'text-[#1075B2]' : ''}`}>
                    <svg className={`fill-current`} width="39" height="39" viewBox="0 0 36 36" xmlns="http://www.w3.org/2000/svg">
                    <path
                    ...
                    <h3 className="mt-[5px] ml-5 font-sans hidden md:flex">Мои заказы</h3>
                </Link>
            </div>
        </div>
    )
