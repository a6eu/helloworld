...
const SignUpForm = ({onLogInClick}) => {
    ...
    return (<form className="w-full max-w-lg px-[50px] flex flex-wrap mb-6" onSubmit={registration}>
            ...
            <div className="flex flex-wrap justify-center w-full mt-6">
                ...
                {!isLoading ? <input
                    ...
                    type="submit" value="Зарегистрироваться"/> : <div
                    className="flex flex-wrap w-[50%] h-8 bg-[#1075B2] justify-center items-center text-white rounded">
                    Регистрация...
                </div>}
            </div>
